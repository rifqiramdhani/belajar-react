...
export default function FunctionalKurang() {
    ...
    return (
        <div>
            ...
            <h1 class="text-center font-p" className='font-p'>Pengurangan</h1>
            ...
            <div class='form-group'>
                ...
                <div class="d-grid gap-2 col-6 mx-auto">
                    <button type="button" className="text-center btn btn-primary my-2 btn-block" onClick={pengurangan}>Submit</button>
                </div>

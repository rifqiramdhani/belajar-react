...
export default function FunctionalKali() {
    ...
    return (
        <div>
            ...
            <h1 className="font-p text-center" >Perkalian</h1>
            ...
            <div class='form-group'>
                ...
                <div class="d-grid gap-2 col-6 mx-auto">
                    <button type="button" className="text-center btn btn-primary my-2 btn-block" onClick={perkalian}>Submit</button>
                </div>
